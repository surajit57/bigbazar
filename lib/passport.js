...
var html_text = '<img src="http://fbbblogstar.in/images/thanksRegisterImage.png"/>';
...
// var html_text_new = 'Test email';
// function send_mail_for_forgot_password(email){
// 	transporter.sendMail({
// 	    from: 'cheers@fbbblogstar.in',
// 	    to: email,
// 	    // bcc: 'shashidhar@teampumpkin.com',
// 	    text: 'Authenticated with OAuth2',
// 	    subject: 'BigBazaar Forgot Password',
// 	    html: html_text_new
// 		}, function(error, response) {
// 		   if (error) {
// 		        console.log('error while sending mail:- ',error);
...
module.exports = function(passport){
  ...
  passport.use(new FacebookStrategy({
   ...
   callbackURL: 'http://fbbblogstar.in/users/auth/facebook/callback',
